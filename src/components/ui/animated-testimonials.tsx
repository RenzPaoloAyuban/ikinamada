...
export const AnimatedTestimonials = ({
  ...
  // Hydration-safe: generate random rotations only on client
  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-20 font-sans font-black-100 antialiased md:max-w-4xl md:px-8 lg:px-12">
